...
class UserLoginViewController: UIViewController {
    ...
    @IBAction func login(_ sender: AnyObject) {
        loginPressed += 1
        let userLoginChallenge = WLClient.sharedInstance().getChallengeHandler(bySecurityCheck: UserLoginChallengeHandler.securityCheckName) as! UserLoginChallengeHandler

...
open class LiveUpdateManager {
     ...
     */
    open func obtainConfiguration (_ segment: String!, useCache: Bool = true, completionHandler: (configuration: Configuration?, error: NSError?) -> Void) {
    ...
    Obtains a configuration from server / cache by params
     ...
     - Parameter completionHandler - the competition for retrieving the Configuration
     */
    open func obtainConfiguration (_ params: [String:String], useCache: Bool = true, completionHandler: (configuration: Configuration?, error: NSError?) -> Void) {
    ...
    fileprivate func obtainConfiguration (_ id : String, url: URL, params: [String: String]?, useCache: Bool, completionHandler: (configuration: Configuration?, error: NSError?) -> Void) {
    ...
    fileprivate func sendConfigRequest(_ id: String, url:URL, params: [String: String]?, completionHandler: (Configuration?, NSError?) -> Void) {
